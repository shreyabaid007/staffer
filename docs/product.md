...
## Out of scope (MVP)
Cultural-fit scoring · multi-role / team formation · real-time / streaming refresh · web UI / bulk upload · cross-role priority allocation · days-on-beach utilisation logic.
